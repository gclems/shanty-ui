...
const AccordionPrimitiveTrigger = ({ className, children, ...props }: ComponentProps<typeof Accordion.Trigger>) => (
    <Accordion.Trigger
        className={cn(
            'group relative flex w-full gap-4 items-baseline justify-between',
            'py-2 pr-1 pl-3',
