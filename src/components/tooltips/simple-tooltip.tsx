    ...
    return <TooltipPrimitive.Root {...props}>
        ...
        <TooltipPrimitive.Portal>
            <TooltipPrimitive.Positioner sideOffset={10}>
                <TooltipPrimitive.Popup {...props} className="flex origin-[var(--transform-origin)] flex-col rounded-md px-2 py-1 text-sm shadow-lg shadow-tooltip-background bg-tooltip-background text-tooltip-foreground outline-1 outline-tooltip-background transition-[transform,scale,opacity] data-[ending-style]:scale-90 data-[ending-style]:opacity-0 data-[instant]:duration-0 data-[starting-style]:scale-90 data-[starting-style]:opacity-0 dark:shadow-none dark:-outline-offset-1">
    ...
    return (
        <svg width="20" height="10" viewBox="0 0 20 10" fill="none" {...props}>
            ...
            <path
                ...
                className="fill-tooltip-background dark:fill-none"
            />
            <path
                d="M10.3333 3.34539L5.47654 7.71648C4.55842 8.54279 3.36693 9 2.13172 9H0V8H2.13172C3.11989 8 4.07308 7.63423 4.80758 6.97318L9.66437 2.60207C10.0447 2.25979 10.622 2.2598 11.0023 2.60207L15.8591 6.97318C16.5936 7.63423 17.5468 8 18.5349 8H20V9H18.5349C17.2998 9 16.1083 8.54278 15.1901 7.71648L10.3333 3.34539Z"
                className="dark:tooltip-background"
            />
        </svg>
    );
}
